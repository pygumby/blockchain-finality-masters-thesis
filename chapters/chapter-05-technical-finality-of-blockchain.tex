...
Most scary, however, is the observation that it is rational for miners to  ``join the selfish pool to increase their revenues.'' \autocite{youtube2018alternativestotonakamotoconsensus}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption*{Cost estimates of rental attacks on Bitcoin}
\end{table}
...
In the following, Stellar, a blockchain system that does provide technical finality are presented.
