...
Whether a payment system is able to provide legal finality depends on the regulatory framework it is embedded in. % -- although, as mentioned before, technical aspects such as the interval of settlement cycles do, to some degree, have an impact.
